...
# ANVIDEA - Capítulo 2
# Archivo: 00_setup.R
# Propósito: configuración general del capítulo 2
...
# ---------------------------------------------------------
# 6. Rutas de archivos de datos y hoja fisicoquímica
# ---------------------------------------------------------

archivo_plancton <- file.path(ruta_datos, "plancton.xlsx")
archivo_invert   <- file.path(ruta_datos, "invert.xlsx")

# Detectar hoja fisicoquímica de invert.xlsx (acepta tildes y variantes)
hoja_fq <- NULL
...
# ---------------------------------------------------------
# 7. Verificación de insumos principales
# ---------------------------------------------------------

archivos_esperados <- c(archivo_plancton, archivo_invert)

faltantes <- archivos_esperados[!file.exists(archivos_esperados)]
