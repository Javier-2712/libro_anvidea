...
required_packages <- c(
  "tidyverse", "readxl", "kableExtra", "forcats", "viridis",
  "corrplot", "psych", "ggrepel", "plotrix", "vegan", "lattice",
  "reshape", "reshape2", "gridExtra", "plotly", "SciViews", "writexl"
)
...
# ---------------------------------------------------------
# 3. Crear carpetas de salida si no existen
# ---------------------------------------------------------
