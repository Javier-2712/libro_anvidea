...
# Uso: source("run_cap1.R")  desde la raíz del capítulo
# =========================================================
...
if (!dir.exists("R"))              stop("Ejecute run_cap1.R desde la raíz del capítulo.")
if (!file.exists("reporte_cap1.qmd")) stop("No se encontró reporte_cap1.qmd.")
...
source(file.path(root_dir, "R", "04_guardar_salidas_cap1.R"))
